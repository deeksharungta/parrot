    ...
    <div className="px-4 sm:px-6 md:px-8 lg:px-10 flex items-center justify-center flex-col relative overflow-hidden pb-8 sm:pb-12 md:pb-16">
      ...
      <div className="w-full max-w-[1340px] relative">
        ...
        <Image
          ...
          width={534}
          height={534}
          className="absolute -bottom-32 sm:-bottom-40 md:-bottom-48 lg:-bottom-56 right-2 sm:right-4 md:right-6 lg:right-10 w-40 h-40 sm:w-64 sm:h-64 md:w-96 md:h-96 lg:w-[534px] lg:h-[534px]"
        />
      </div>
    </div>
  );
