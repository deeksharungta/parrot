        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              contain: "layout style", // Contain layout changes within this element
            }}
          >
            ...
            <p className="text-sm text-[#8C8A94] mb-6">
              Scan the QR code with your phone to authorize your signer
            </p>
            ...
            <div className="flex flex-col items-center space-y-4">
              <div
                className="bg-white p-4 rounded-xl border border-[#ECECED] shadow-sm"
                style={{
                  minHeight: "232px",
                  display: "flex",
                  alignItems: "center",
              ...
              <p className="text-sm text-[#8C8A94] text-center max-w-sm leading-relaxed">
                Scan this QR code with your mobile device to authorize the
                signer
              </p>
            </div>
          </motion.div>
